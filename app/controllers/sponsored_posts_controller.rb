class SponsoredPostsController < ApplicationController
  ...
  def create
    ...
    @sponsored_post.id = params[:sponsored_post][:id]
    ...
    @sponsored_post.topic = @topic
     ...
     if @sponsored_post.save
       ...
       redirect_to [@topic, @sponsored_post] #Because this is create new post, we retrieve the post that just created under the current topic 
     else
  ...
  def update
    ...
    if @sponsored_post.save
       flash[:notice] = "Sponsored Post was updated successfully."
        ...
        #Because this is update an existing post, we retrieve the current post under the topic of this current post only, not of others post
    else
       flash.now[:alert] = "There was an error saving the sponsored post. Please try again."
       render :edit
    end
